...
func (c *lSeqDatabaseClient) SyncPut_(ctx context.Context, in *DBItems, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedLSeqDatabaseServer) SyncPut_(context.Context, *DBItems) (*empty.Empty, error) {
